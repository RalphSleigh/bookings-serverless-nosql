...
handlerSetup('/api/event/:id/manage/booking/history/:userId', 'events/manage/getHistoricalSingleBooking')
handlerSetup('/api/event/:id/manage/getParticipantNumbersChartData', 'events/manage/getParticipantNumbersChartData')
