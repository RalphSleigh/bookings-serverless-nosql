...
export abstract class FeeStructure {
    ...
    public abstract getFeeLines: (event: JsonEventType, booking: Partial<JsonBookingType>) => FeeLine[]
    public abstract DescriptionElement: React.FC<{event: JsonEventType, booking: Partial<JsonBookingType>}>
